...
**From npm — the short way.** Nothing to clone and nothing to build; paste the config block at
...
> beside the code, as it always has. A package install (`npx`, `npm i -g`) writes them to
